...
public class MaterialTrueRoyalMidasGoldSword extends Material implements IArmorMaterial, IArrowMaterial, IRepairableMaterial, IToolMaterial {
    @Override
    ...
    public MaterialTrueRoyalMidasGoldSword(EnumEquipmentMaterial enum_crafting_material) {
