...
public class MaterialMidasGold extends Material implements IArmorMaterial, IArrowMaterial, ICoinMaterial, IRepairableMaterial, IToolMaterial {
    @Override
    ...
    public ItemCoin getForInstance() {
        return MMItems.midas_gold_coin;
    }
