...
public class MaterialStormyx extends Material implements IArmorMaterial, IArrowMaterial, IRepairableMaterial, IToolMaterial {
    @Override
    ...
    public MaterialStormyx(EnumEquipmentMaterial enum_crafting_material) {
