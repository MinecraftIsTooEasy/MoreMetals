...
public class MaterialRoseGold extends Material implements IArmorMaterial, IArrowMaterial, ICoinMaterial, IRepairableMaterial, IToolMaterial {
    @Override
    ...
    public MaterialRoseGold(EnumEquipmentMaterial enum_crafting_material) {
        super(enum_crafting_material);
        this.setRequiresTool().setMetal(true).setHarmedByLava(false).setMinHarvestLevel(3);
    }
    ...
    public Item getRepairItem() {
        return MMItems.rose_gold_nugget;
    }
