...
public class MaterialBronze extends Material implements IArmorMaterial, IArrowMaterial, ICoinMaterial, IRepairableMaterial, IToolMaterial {
    @Override
