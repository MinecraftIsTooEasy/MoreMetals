...
public class MMBlocks extends Block {
    ...
    public static final Block oreStormyx = (new BlockOre(getNextBlockID(), Materials.stormyx, 2)).setHardness(3.0F).setStepSound(Block.soundStoneFootstep).setCreativeTab(MMCreativeTab.MISC_TAB);
    ...
    public static final Block blockCelestium = (new BlockOreBlockExtend(getNextBlockID(), Materials.celestium)).setHardness(3.0F).setStepSound(Block.soundStoneFootstep).setCreativeTab(MMCreativeTab.MISC_TAB);
    ...
    public static final Block blockStormyx = (new BlockOreBlockExtend(getNextBlockID(), Materials.stormyx)).setHardness(3.0F).setStepSound(Block.soundStoneFootstep).setCreativeTab(MMCreativeTab.MISC_TAB);
    ...
    public static void registerItemBlocks(ItemRegistryEvent registryEvent) {
        ...
        registryEvent.registerItemBlock(NameSpace,"moremetals:stormyx_ore","stormyx_ore",oreStormyx);
        ...
        registryEvent.registerItemBlock(NameSpace,"moremetals:celestium_block","celestium_block",blockCelestium);
        registryEvent.registerItemBlock(NameSpace,"moremetals:tin_block","tin_block",blockTin);
        registryEvent.registerItemBlock(NameSpace,"moremetals:stormyx_block","stormyx_block",blockStormyx);
