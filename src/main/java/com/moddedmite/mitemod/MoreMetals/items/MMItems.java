...
public class MMItems extends Item {
    ...
    public static final ItemNugget rose_gold_nugget = new MMItemNugget(getItemId("rose_gold_nugget"), Materials.rose_gold,"rose_gold_nugget");
    public static final ItemNugget titanium_alloy_nugget = new MMItemNugget(getItemId("titanium_alloy_nugget"), Materials.titanium_alloy,"titanium_alloy_nugget");
    ...
    public static final ItemPickaxe adamantium_pickaxe = ReflectHelper.createInstance(ItemPickaxe.class, new Class[]{int.class, Material.class}, getNextItemID(), Materials.adamantium_mm);
