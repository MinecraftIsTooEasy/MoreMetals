...
public class MaterialRoyalMidasGoldGreatsword extends Material implements IArmorMaterial, IArrowMaterial, IRepairableMaterial, IToolMaterial {
    @Override
    ...
    public MaterialRoyalMidasGoldGreatsword(EnumEquipmentMaterial enum_crafting_material) {
