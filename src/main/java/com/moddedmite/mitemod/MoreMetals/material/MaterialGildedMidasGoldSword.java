...
public class MaterialGildedMidasGoldSword extends Material implements IArmorMaterial, IArrowMaterial, IRepairableMaterial, IToolMaterial {
    @Override
    ...
    public MaterialGildedMidasGoldSword(EnumEquipmentMaterial enum_crafting_material) {
