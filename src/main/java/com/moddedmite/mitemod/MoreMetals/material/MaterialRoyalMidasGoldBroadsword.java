...
public class MaterialRoyalMidasGoldBroadsword extends Material implements IArmorMaterial, IArrowMaterial, IRepairableMaterial, IToolMaterial {
    @Override
    ...
    public MaterialRoyalMidasGoldBroadsword(EnumEquipmentMaterial enum_crafting_material) {
